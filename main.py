...
class CharacterRegistrationModal(Modal):
    def __init__(self):
        ...
        self.select = Select(
            placeholder="Selecione a classe do personagem...",
            options=[
                discord.SelectOption(label="Saber", value="Saber"),
                discord.SelectOption(label="Ranger", value="Ranger"),
                discord.SelectOption(label="Lancer", value="Lancer"),
                discord.SelectOption(label="Fighter", value="Fighter"),
                discord.SelectOption(label="Mage", value="Mage"),
                discord.SelectOption(label="Summoner", value="Summoner"),
                discord.SelectOption(label="Assassin", value="Assassin"),
                discord.SelectOption(label="Berserk", value="Berserk"),
            ],
            min_values=1,  
            max_values=1   
        )
    ...
    async def on_submit(self, interaction: discord.Interaction):
        ...
        embed = discord.Embed(
            ...
            description=f"O personagem **{character_name}** da classe **{character_class}** foi registrado com sucesso!",
...
@bot.tree.command(guild=discord.Object(id=id_do_servidor), name='registro', description='Registrar um novo personagem')
